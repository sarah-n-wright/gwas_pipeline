...
#SBATCH --output /cellar/users/snwright/Data/SlurmOut/exome_QC/redo_%A_%a.out
...
source /cellar/users/snwright/Git/gwas_pipeline/gwas_1_common_snps.sh $config $CHR
