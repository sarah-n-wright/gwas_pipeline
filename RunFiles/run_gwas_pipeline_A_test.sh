...
source /nrnb/ukb-majithia/sarah/Git/gwas_pipeline/gwas_1_common_snps.sh $config $CHR $out

echo "############################ GWAS 1 COMPLETED ##########################"

source /nrnb/ukb-majithia/sarah/Git/gwas_pipeline/gwas_2_missingness.sh $config $CHR

echo "############################ GWAS 2 COMPLETED ##########################"

source /nrnb/ukb-majithia/sarah/Git/gwas_pipeline/gwas_3_check_missing_hwe.sh $config $CHR

echo "############################ GWAS 3 COMPLETED ##########################"

source /nrnb/ukb-majithia/sarah/Git/gwas_pipeline/gwas_4_prune_LD.sh $config $CHR
