...
source /cellar/users/snwright/Git/gwas_pipeline/gwas_sex_combine.sh $config ''

echo "############################ GWAS 5a COMPLETED##########################"

source /cellar/users/snwright/Git/gwas_pipeline/gwas_5_sex.sh $config $CHR

#echo "############################ GWAS 5 COMPLETED ##########################"

#source /cellar/users/snwright/Git/gwas_pipeline/gwas_6_ibd.sh $config $CHR

#echo "############################ GWAS 6 COMPLETED ##########################"

# source /cellar/users/snwright/Git/gwas_pipeline/gwas_7_pca.sh $config
